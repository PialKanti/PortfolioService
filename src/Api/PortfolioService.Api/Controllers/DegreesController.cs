...
using PortfolioService.Api.Dtos.Request.Degrees;
...
namespace PortfolioService.Api.Controllers
{
    ...
    {
        private readonly IDegreeRepository<Degree> _repository;
        private readonly IMapper _mapper;

        public DegreesController(IDegreeRepository<Degree> repository, IMapper mapper)
        {
        ...
        {
            var entity = _mapper.Map<Degree>(request);
